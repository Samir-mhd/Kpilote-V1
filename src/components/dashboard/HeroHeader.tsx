...
export default function HeroHeader({
    ...
    return (
        <section className="relative rounded-[24px] bg-gradient-to-br from-slate-950 via-violet-900 to-indigo-900 px-6 py-4 text-white shadow-[0_30px_90px_rgba(0,0,0,.35)]">

            {/* Halos clippés dans leur propre wrapper */}
            ...
            <div className="relative">
                <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-2 max-w-xl text-base leading-6 text-white/80">{message}</p>
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                            ...
                            {defi && (
                                <div className="rounded-full bg-orange-500/20 px-4 py-2 text-sm text-orange-300">
                                    ⚔ Défi en cours
                                </div>
                            )}
                        </div>
                    ...
                    {/* ── Droite : avatar ────────────────────────────────── */}
                    <div className="flex flex-col items-center xl:mb-[-50px] flex-shrink-0">
                        <CartoonAvatar
                            prenom={nom}
                            etat={avatarEtat}
                            size={380}
